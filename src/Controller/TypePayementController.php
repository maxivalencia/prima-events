...
class TypePayementController extends AbstractController
{
     ...
     */
    public function index(TypePayementRepository $typePayementRepository, Request $request, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $typePayementRepository->findAll(), /* query NOT result */
            $request->query->getInt('page', 1)/*page number*/,
            10/*limit per page*/
        );
        return $this->render('type_payement/index.html.twig', [
            'type_payements' => $pagination,
        ]);
    }
